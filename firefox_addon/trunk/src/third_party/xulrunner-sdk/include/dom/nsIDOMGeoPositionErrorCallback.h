/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/moz2_slave/mozilla-1.9.1-linux-xulrunner/build/dom/public/idl/geolocation/nsIDOMGeoPositionErrorCallback.idl
 */

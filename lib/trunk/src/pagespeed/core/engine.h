...
class Engine {
 public:
  ...
  // Estimate the bitmap of RuleRequirements capabilities for this
  // PagespeedInput. Note that implementers should call this method
  ...
  static uint32 EstimateCapabilitiesBitmap(const PagespeedInput& input);

  ...
  'targets': [
    {
      ...
      'dependencies': [
        ...
        '<(pagespeed_root)/pagespeed/image_compression/image_compression.gyp:pagespeed_jpeg_utils',
      ...
      'sources': [
        ...
        'rules/avoid_charset_in_meta_tag.cc',
        'rules/avoid_css_import.cc',
        'rules/avoid_excess_serialization.cc',
        'rules/avoid_flash_on_mobile.cc',
        'rules/avoid_landing_page_redirects.cc',
    ...
    },
    {
      ...
      'sources': [
        ...
        'filters/landing_page_redirection_filter_test.cc',
        ...
        'rules/avoid_charset_in_meta_tag_test.cc',
        'rules/avoid_css_import_test.cc',
        'rules/avoid_excess_serialization_test.cc',
        'rules/avoid_flash_on_mobile_test.cc',
        'rules/avoid_landing_page_redirects_test.cc',
    ...
    },
    {
      ...
      'dependencies': [
        ...
        '<(pagespeed_root)/pagespeed/image_compression/image_compression.gyp:pagespeed_image_resizer',
      ...
      'sources': [
        ...
        'image_compression/image_resizer_test.cc',
        'image_compression/jpeg_optimizer_test.cc',
        'image_compression/jpeg_utils_test.cc',

  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        '<(instaweb_root)/rewriter/css_tag_scanner.cc',
        ...
        '<(instaweb_root)/rewriter/img_tag_scanner.cc',
        ...
        '<(instaweb_root)/rewriter/resource_tag_scanner.cc',
        '<(instaweb_root)/rewriter/rewrite_driver.cc',
        '<(instaweb_root)/rewriter/rewrite_driver_factory.cc',
        '<(instaweb_root)/rewriter/rewrite_filter.cc',
        '<(instaweb_root)/rewriter/script_tag_scanner.cc',
    ...
    },
    {
      ...
      'sources': [
        ...
        '<(instaweb_root)/util/auto_make_dir_file_system.cc',
        ...
        '<(instaweb_root)/util/delay_controller.cc',
        ...
        '<(instaweb_root)/util/http_response_parser.cc',
